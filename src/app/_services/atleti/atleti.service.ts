...
import { Atleta } from '../../models/atleta/atleta.model';
...
export class AtletiService {
  ...
  // http://localhost:3000/api/lista/atleti/gara/filterbypunteggio?/lista/atleti/gara/filterbypunteggio?totalePunti=4
  getAtletafilterbypunteggio(totalePunti): Observable<Atleta[]> {
    ...
    let url = `${this.baseUri}/lista/atleti/gara/filterbypunteggio?totalePunti=${totalePunti}`;
    return this.http.get<Atleta[]>(url, httpOptions);
  }
